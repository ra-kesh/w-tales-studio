...
import { useTaskPriorityColumns } from "./task-priority-table-columns";
import { TaskPriorityTableToolbar } from "./task-priority-table-toolbar";
...
export function TaskPriorityTable({
	...
	const columns = useTaskPriorityColumns();
	...
	return (
		<div className="space-y-4">
			<TaskPriorityTableToolbar table={table} />
