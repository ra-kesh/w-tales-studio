...
import { useTaskStatusColumns } from "./task-status-table-columns";
import { TaskStatusTableToolbar } from "./task-status-table-toolbar";
...
export function TaskStatusTable({
	...
	return (
		<div className="space-y-4">
			<TaskStatusTableToolbar table={table} />
