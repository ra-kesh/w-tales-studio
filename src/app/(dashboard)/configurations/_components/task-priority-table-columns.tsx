...
import { TaskPriorityTableRowActions } from "./task-priority-row-action";
...
export const useTaskPriorityColumns = () => {
	const columns: ColumnDef<TaskPriorityRow>[] = [
		{
			id: "select",
			header: ({ table }) => (
				<Checkbox
		...
		{
			id: "actions",
			cell: ({ row }) => <TaskPriorityTableRowActions row={row} />,
		},
	];
