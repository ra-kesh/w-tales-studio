...
import type { DeliverableStats as DeliverableStatType } from "@/lib/db/queries";

export function DeliverableStats({ stats }: { stats: DeliverableStatType }) {
	const metrics = [
		{
		...
		},
		{
			...
			value: stats?.activeDeliverables || 0,
		},
		{
		...
		},
		{
			...
			value: stats?.overdueDeliverables || 0,
		},
	];
