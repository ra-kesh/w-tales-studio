...
import type { PaymentsStats as PaymentsStatsType } from "@/lib/db/queries";

export function PaymentsStats({ stats }: { stats: PaymentsStatsType }) {
	const metrics = [
		{
		...
		},
		{
			...
			value: Number(stats?.totalScheduled || 0),
			isCurrency: true,
		},
		{
	...
	return (
		<div className="relative isolate overflow-hidden mb-8">
