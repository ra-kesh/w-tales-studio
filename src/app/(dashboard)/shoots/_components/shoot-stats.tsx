...
import type { ShootStats } from "@/lib/db/queries";

export function ShootsStats({ stats }: { stats: ShootStats }) {
	const metrics = [
		{
			title: "Total Shoots",
			value: stats?.totalShoots || 0,
		},
		{
			title: "Upcoming Shoots",
			value: stats?.upcomingShoots || 0,
		},
		{
			title: "Unstaffed Shoots",
			value: stats?.unstaffedUpcomingShoots || 0,
		},
		{
			title: "Completed Shoots",
			value: stats?.pastShoots || 0,
		},
	];
