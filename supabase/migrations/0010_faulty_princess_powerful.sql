...
ALTER TABLE "shoots" ALTER COLUMN "organization_id" SET NOT NULL;

-- Step 5: Add the foreign key constraint
ALTER TABLE "shoots"
ADD CONSTRAINT "shoots_organization_id_organizations_id_fk"
